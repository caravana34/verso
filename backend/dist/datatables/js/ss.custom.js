...
// dataSrc="data" it is array source of data
   ...
   function initDatatable(_selector,_url,params={},rm_export_btn=[],pageLength=25,aoColumnDefs=[{ "bSortable": false, "aTargets": [ -1 ] ,'sClass': 'dt-body-right'}],searching=true,aaSorting=[],dataSrc="data"){
...
//          lengthMenu: [[100,25, -1], [100,25, "All"]],
