...
//             exit;
    ...
    public function searchDataTablePatientRecord($searchterm)
    {
        ...
        $this->datatables 
            ...
            ->searchable('"",patients.id,patients.patient_name,patients.is_dead,patients.age,patients.gender,patients.mobileno,patients.guardian_name,patients.address,patients.identification_number' . $custom_field_column)
...
//         exit;
    ...
    public function addvisitDetails($opd_data)
    {
        ...
        if (isset($opd_data["opd_id"])){
//             print_r("aqui 1");
            $this->db->where("opd_details_id",$opd_data["opd_id"])->update("visit_details", $opd_data);
        }else if(isset($opd_data["opd_details_id"])){
//             $this->db->insert("visit_details", $opd_data);
            $this->db->insert("visit_details", $opd_data);
//              $this->db->where("opd_details_id",$opd_data["opd_details_id"])->update("visit_details", $opd_data);
//             print_r("aqui 2");
        }else{
          $this->db->insert("visit_details", $opd_data); 
//             print_r("aqui 3");
...
//         return $opd_data;
    ...
    {
        $result = $this->db
            ->select("id,patient_name,guardian_name, identification_number")
            ->group_start()
    ...
    public function add_custom($custom_data_img){
//         $this->db->insert('custom_field_values', $custom_data_img);
        $this->db->set('belong_table_id', $custom_data_img['id']);
        $this->db->set('custom_field_id', $custom_data_img['custom_field_id']);
        $this->db->set('field_value', $custom_data_img['image']);
        $this->db->insert('custom_field_values');
