...
class Prescription_model extends MY_Model
{
   ...
   public function insertPrescriptionBasic($datos)
   {
     
     $this->db->insert("ipd_prescription_basic", $datos);
     return  $this->db->insert_id();
  
   }
  
   public function insertPrescriptionDetails($datos)
   {
     
     $this->db->insert("ipd_prescription_details", $datos);
     return  $this->db->insert_id();
