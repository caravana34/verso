                    ...
                    <div class="box-header with-border">
                        ...
                        <?php if ($this->rbac->hasPrivilege('notice_board', 'can_add')) { ?>
                            <div class="box-tools pull-right">
                                <a href="<?php echo base_url() ?>admin/notification/add" class="btn btn-sm"><i class="fa fa-plus"></i> <?php echo $this->lang->line('post_new_message'); ?></a>
                                <?php
                            }
                            if ($this->rbac->hasPrivilege('email_sms', 'can_view')) {
                                ?>
                                <a href="<?php echo base_url(); ?>admin/mailsms/compose" class="btn btn-sm"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('send_sms'); ?></a>
                            <?php } if ($this->rbac->hasPrivilege('email_sms', 'can_view')) {
                                ?>
                                <a href="<?php echo base_url(); ?>admin/mailsms/composemail" class="btn btn-sm"><i class="fa fa-reorder"></i> <?php echo $this->lang->line('send_email'); ?></a>
                            <?php } ?>
                        </div>
                                        ...
                                        <div class="box-header with-border">
                                            ...
                                            <div class="pull-right pt5">
                                                <?php if (($this->rbac->hasPrivilege('notice_board', 'can_edit')) || ($notification["created_id"] == $user_id)) { ?>
                                                    <a href="<?php echo base_url() ?>admin/notification/edit/<?php echo $notification['id'] ?>" class="btn btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>" data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    &nbsp; <?php } if (($this->rbac->hasPrivilege('notice_board', 'can_delete')) || ($notification["created_id"] == $user_id)) { ?>                                            
                                                    <a onclick="delete_record(<?php echo $notification['id'] ?>)"  class="btn btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" data-original-title="<?php echo $this->lang->line('delete'); ?>">
