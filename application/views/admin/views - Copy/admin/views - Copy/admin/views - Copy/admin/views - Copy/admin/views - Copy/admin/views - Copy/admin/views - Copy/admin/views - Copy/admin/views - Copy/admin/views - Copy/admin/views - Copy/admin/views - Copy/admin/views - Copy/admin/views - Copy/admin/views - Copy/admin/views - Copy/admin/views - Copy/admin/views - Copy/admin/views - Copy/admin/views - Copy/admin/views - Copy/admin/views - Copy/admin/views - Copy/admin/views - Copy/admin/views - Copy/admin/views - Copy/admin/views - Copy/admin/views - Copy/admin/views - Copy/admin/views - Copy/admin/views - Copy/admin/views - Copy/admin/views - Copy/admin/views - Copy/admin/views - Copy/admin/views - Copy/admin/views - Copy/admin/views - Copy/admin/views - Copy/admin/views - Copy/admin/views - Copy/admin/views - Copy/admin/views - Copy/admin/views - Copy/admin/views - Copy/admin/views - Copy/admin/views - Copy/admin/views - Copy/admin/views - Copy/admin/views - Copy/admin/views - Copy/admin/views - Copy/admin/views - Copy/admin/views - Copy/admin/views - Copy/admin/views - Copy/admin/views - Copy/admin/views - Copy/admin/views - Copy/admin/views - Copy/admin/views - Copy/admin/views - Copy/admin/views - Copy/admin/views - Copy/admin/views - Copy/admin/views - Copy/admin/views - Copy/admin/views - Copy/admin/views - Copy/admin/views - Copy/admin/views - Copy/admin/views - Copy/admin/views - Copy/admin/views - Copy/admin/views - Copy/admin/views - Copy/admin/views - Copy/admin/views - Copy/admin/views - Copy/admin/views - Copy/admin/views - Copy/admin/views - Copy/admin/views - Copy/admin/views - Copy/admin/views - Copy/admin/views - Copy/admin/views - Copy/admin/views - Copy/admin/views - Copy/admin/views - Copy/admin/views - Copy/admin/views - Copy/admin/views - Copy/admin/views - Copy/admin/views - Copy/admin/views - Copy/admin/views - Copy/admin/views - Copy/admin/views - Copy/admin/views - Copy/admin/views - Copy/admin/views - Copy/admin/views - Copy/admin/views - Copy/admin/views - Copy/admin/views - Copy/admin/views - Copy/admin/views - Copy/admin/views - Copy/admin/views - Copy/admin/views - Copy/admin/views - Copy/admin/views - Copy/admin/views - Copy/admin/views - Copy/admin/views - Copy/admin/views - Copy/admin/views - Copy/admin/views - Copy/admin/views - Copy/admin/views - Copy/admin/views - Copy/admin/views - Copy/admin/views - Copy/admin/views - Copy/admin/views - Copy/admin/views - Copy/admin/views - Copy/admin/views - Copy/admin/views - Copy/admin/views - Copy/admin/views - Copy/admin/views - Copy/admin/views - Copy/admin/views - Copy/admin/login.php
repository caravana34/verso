    ...
    <head>
        ...
        <style type="text/css">
           ...
           #backstretch {
              ...
              height: 100%;
              z-index: -9999;
              background-size: cover; /* Add this line to make the image cover the entire container */
              background-position: center; /* Add this line to center the image */
          }
            .col-md-offset-3 { margin-left: 29%;}
            .loginbg {
/*                 background: linear-gradient(to bottom, rgba(255,255,255,0.15) 0%, rgba(0,0,0,0.15) 100%), radial-gradient(at top center, rgba(255,255,255,0.10) 0%, rgba(0,0,0,0.10) 10%) #cbcaca; */
...
/*                  background-color: rgba(133, 134, 134, 0.8); */
                 background-image: url("<?php echo base_url(); ?>uploads/own_cliniverso/imgs/fondo_login.png");
/*              background: #9e979b; */
/*                 max-height: 480px; */
/*                 box-shadow:0 10px 18px 0 rgba(rgba(71, 160, 255)); */
            ...
            a.forgot {padding-top:0px; color: #fff;}
            ...
            button.btn:hover {opacity: 100 !important; color: #fff;background: #1563b0;}
                            ...
                            <div class="loginbg">  
                                <div class="form-top">
                                    ...
                                    <div class="" style="text-align-last:center;"> 
                                        <img src="<?php echo $logo_image.img_time(); ?>"  style="max-height:70px;width:auto; margin-top: 10px;">  
                                    </div>
<!--                                     <div class="form-top-right">
                                        <i class="fa fa-key text-2"></i>
                                    </div> -->
                                </div>
                                <div class="form-bottom">
<!--                                     <h3 class="font-white bolds"><?php echo $this->lang->line('admin_login'); ?></h3> -->
                                  <h3 class="font-white bolds">Inicio de Sesión</h3>
                                    <?php
                                    ...
                                    <form action="<?php echo site_url('site/login') ?>" method="post">
                                        ...
                                        <div class="form-group">                                           
                                            ...
                                            <br><input id="shorPassword" type="checkbox" onclick="view_password()"> Ver contraseña
                                    ...
                                    <br>
                                    <p><center><a style="color:#c8f7f7;" href="<?php echo site_url('site/forgotpassword') ?>" class="forgot"><i class="fa fa-key"></i> <?php echo $this->lang->line('forgot_password'); ?>?</a> </center></p> 
                                </div>
                            </div>
                        </div>
                        <?php 
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.backstretch([
            base_url +  "uploads/own_cliniverso/imgs/LOGIN-CLINIVERSO(3).webp"
        ], {duration: 800, fade: 50});
...
<script type="text/javascript">
 ...
 function view_password(){
     var passwordInput = document.getElementById("password");
        var checkbox = document.getElementById("shorPassword");
