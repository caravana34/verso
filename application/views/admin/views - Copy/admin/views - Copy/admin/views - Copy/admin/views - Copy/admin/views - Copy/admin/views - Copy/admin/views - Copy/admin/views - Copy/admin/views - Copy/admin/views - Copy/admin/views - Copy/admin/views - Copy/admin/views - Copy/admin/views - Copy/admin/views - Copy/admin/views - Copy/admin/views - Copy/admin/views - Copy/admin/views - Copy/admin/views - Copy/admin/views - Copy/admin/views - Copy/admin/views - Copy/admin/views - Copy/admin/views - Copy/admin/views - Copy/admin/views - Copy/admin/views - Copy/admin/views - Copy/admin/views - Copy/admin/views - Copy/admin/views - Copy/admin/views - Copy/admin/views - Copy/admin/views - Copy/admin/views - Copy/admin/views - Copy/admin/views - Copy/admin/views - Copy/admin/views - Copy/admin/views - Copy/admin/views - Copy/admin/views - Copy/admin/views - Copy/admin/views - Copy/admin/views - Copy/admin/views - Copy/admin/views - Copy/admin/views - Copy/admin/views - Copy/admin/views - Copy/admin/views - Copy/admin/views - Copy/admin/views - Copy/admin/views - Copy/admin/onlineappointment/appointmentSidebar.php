<div class="box border0">
    ...
    <?php if ($this->rbac->hasPrivilege('online_appointment_shift', 'can_view')) { ?>
    <ul class="tablists">
         <li><a href="<?php echo site_url('admin/onlineappointment/programming_settings'); ?>" class="<?php echo set_sidebar_Submenu('admin/onlineappointment/programming_settings'); ?>">Bloquear agenda</a></li>
    </ul>
    <?php } ?>
</div>
