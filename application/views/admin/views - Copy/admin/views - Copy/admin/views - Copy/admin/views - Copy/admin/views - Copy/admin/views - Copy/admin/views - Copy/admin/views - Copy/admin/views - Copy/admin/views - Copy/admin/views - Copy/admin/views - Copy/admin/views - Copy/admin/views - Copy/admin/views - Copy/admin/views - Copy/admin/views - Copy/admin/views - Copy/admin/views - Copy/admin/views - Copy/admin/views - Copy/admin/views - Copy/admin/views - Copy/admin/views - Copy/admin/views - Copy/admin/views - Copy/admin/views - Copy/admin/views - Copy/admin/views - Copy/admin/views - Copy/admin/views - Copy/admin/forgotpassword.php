...
/*             .form-top {background:#39f;
            ...
            button.btn:hover {
                opacity: 100 !important; color: #fff;background: #fbc02d;
            }
                          ...
                          <div class="loginbg">  
                            <div class="form-top">
                                <div class="" style="text-align-last:center;"> 
                                        <img src="https://clinify.co/cliniverso_dev/uploads/hospital_content/logo/1.png" style="max-height:70px;width:auto; margin-top: 10px;">  
                                    </div>
                            </div>
