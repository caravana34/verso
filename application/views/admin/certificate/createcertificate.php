    ...
    <section class="content">
        <div class="row">
            ...
            if ($this->rbac->hasPrivilege('certificate', 'can_add')) {
                ?>
                <a data-toggle="modal" data-target="#myModal" class="btn btn-sm uploadcontent"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_certificate_template'); ?>
                            </a>
            <?php } ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            ...
            <div class="modal-footer">         
                    <button type="submit" data-loading-text="<?php echo $this->lang->line('processing'); ?>" id="formaddbtn" class="btn pull-right"> <i class="fa fa-check-circle"></i>  <?php echo $this->lang->line('save'); ?></button>
                </div>
            </form>
        </div>
    </div>
