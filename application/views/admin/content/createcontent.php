                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools addmeeting">
                            <?php if ($this->rbac->hasPrivilege('upload_content', 'can_add')) {?>
                                <a data-toggle="modal" data-target="#myModal" class="btn btn-sm uploadcontent"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('upload_content'); ?></a>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="box-body">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="modal-title" style="color:#1563B0;"><?php echo $this->lang->line('upload_content'); ?></h4>
            </div>
            ...
            <div class="modal-footer">
                <div class="pull-right">
                    <button type="submit" data-loading-text="<?php echo $this->lang->line('processing') ?>" id="upload_contentbtn" class="btn"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                </div>
            </div>
        </form>
        </div>
