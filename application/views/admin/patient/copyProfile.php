                ...
                <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs navlistscroll">
                            ...
                            <?php } if ($this->rbac->hasPrivilege('opd_lab_investigation', 'can_view')) { ?>
                                <li><a href="#labinvestigation" data-toggle="tab" aria-expanded="true"><i class="fas fa-diagnoses"></i> Medicamento0000000s</a></li>
                              <?php } if ($this->rbac->hasPrivilege('opd_treatment_history', 'can_view')) { ?>
                            <li><a href="#treatment_history" data-toggle="tab" aria-expanded="true"><i class="fas fa-diagnoses"></i> Ayudas diagnósticas</a></li>
                            <?php } if ($this->rbac->hasPrivilege('opd_timeline', 'can_view')) { ?>
                                <li><a href="#timeline" data-toggle="tab" aria-expanded="true"><i class="fas fa-users fa-2xs"></i> Incapacidad</a></li>
...
<!--                                                     <h3 class="text-uppercase bolds mt0 ptt10 pull-left font14"><?php echo composePatientName($result['patient_name'],$result['id']); ?></h3> -->
                                                        <div class="row">
                                                            <h2 class="text-uppercase bolds mt0 ptt10 pull-left font14" style="margin: 5px 0px 5px 0px;"><?php echo $result['patient_name'] ;?> <?php echo $result['guardian_name'] ;?> <?php echo $result['id'] ;?></h2>
                                                            </h2>
                                                        </div>
                                                        <div class="row" style="margin-top: 8px;">
                                                            <a href='#' id="editomodal2" class='btn btn-primary btn-md ' 
                                                               style="text-align-last:end; border-radius:20px !important;" 
                                                               onclick="editRecord2('<?php echo $result['id'] ?>')" 
                                                               
                                                               data-toggle='' title="<?php echo $this->lang->line('edit'); ?>" data-mdb-toggle="animation" data-mdb-animation-reset="true" data-mdb-animation="zoom-in"> <i class="fa fa-edit"></i>  Paciente </a>                                                       
                                                        </div>
                                                </div> 
                                                <div class=" col-lg-6 col-md-6 col-sm-12 box-tab-tools" style="text-align-last:end;margin: 0px; margin-top: 35px;">
                                                     <?php if ($this->rbac->hasPrivilege('visit', 'can_add')) { ?>
                                                  <?php if(isset($appoint_id_visit)){?>
                                                        <a href="#" id="edmodal2"  onclick="getRevisitRecord('<?php echo $opd_details_id['opdid'] ?>', '<?php echo $result['id'] ?>'),holdModal('revisitModal')" class="btn btn-primary btn-md revisitpatient" style="border-radius: 20px;" data-toggle="modal" title="">
...
<!--                                                         <td class="bolds"><?php echo $this->lang->line('phone'); ?></td> -->
                                    ...
                                    <p><b><i class="fa fa-tag"></i> Enfermedad actual:</b></p>  
                                     <ul>
                                         <!-- by bad_dev -->
...
<!--                                                               <td><?php echo  nl2br($value['refference']); ?></td> -->
                                                            <td><a href="#" onclick="getRecord_id('<?php echo $value['visit_id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="Agregar receta"><i class="fas fa-prescription"></i><h6 style="margin: 0px;">Medicamentos</h6></a></td>
                                                        </tr>
                                                    <?php } }  ?>
                        ...
                        <div class="tab-pane" id="labinvestigation">
                            <div class="box-tab-header">
                                <h3 class="box-tab-title">Medicamentos</h3>
                            </div>
                             <div class="row">
                    <div class="col-sm-12">
                    <div class="ptt10">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('header_note'); ?>f</label> 
                            ...
                            <tr id="row1">
                                    ...
                                    <input type="hidden" name="rows[]" value="1">          
                                        <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                            ...
                                            <select onkeyup="filtercategories();" id="incodol_categories" class="form-control" style="width: 100%" name='medicine_cat_1'>
...
<!--                                             <div class="">
                                                <label>
                                            <?php echo $this->lang->line('medicine_category'); ?>rrr</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                            <div class="">
                                                ...
                                                <select id="incodol_medicines" class="form-control select2 medicine_name" data-rowid="1" style="width: 100%"  name="medicine_1">
                                                    <option value=""><?php echo $this->lang->line('select');?></option>
                                                </select>
                                        ...
                                        <div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                            <div class="">
                                                ...
                                                <select id="incodol_dosis" class="form-control select2 medicine_dosage" style="width: 100%"  name="dosage_1">
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                </select>
                                            </div> 
                                        </div>
...
<!--                     <div class="col-sm-12">
                    <div class="ptt10">
                        ...
                        <div class="tab-pane" id="treatment_history">
                            <div class="box-tab-header">
                                <h3 class="box-tab-title">Ayudas diagnósticas</h3>
                            </div>
...
<!--                             <div class="table-responsive">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 border-r">
                                     <?php echo "1"; ?>
                                    <select style="width:200px;" id="cups">
                                    </select> 
                                    <select style="width:200px;" id="Capítulo">
                                    </select> 
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12 border-r">
                                    <select style="width:200px;" id="Sección">
                                    </select> 
                                </div>
                            ...
                            <div class="row">
                               <div class="col-lg-4 col-md-4 col-sm-4">
                                  <div class="form-group" style="margin: 0px !important;">
                                      <label>Buscar medicamentos</label><small>&nbsp;<i class="fa fa-search"></i></small> 
                                      <input type="text" class="form-control" id="search_cups" onkeyup="filter_cups()" autocomplete="off" name="search_medicine" placeholder="Buscar medicamento">
                                      <span class="text-danger"></span>
                                  </div>
                                   <div class="usersearchlist">
                                        <ul class="list-group scroll-container" id="cups_deatils" hidden>        
                                        </ul>
                                   </div>
                              </div>
                              ...
                              <div class="col-lg-8 col-md-6 col-sm-12">
                                    <div class="blood-body">
                                        <div class="blood-pull-left blood-title">Medicamentos</div>
                                    </div>     
                                        ...
                                        <table class="table table-hover table-bordered bloodtable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td></td>                    
                                                    <td></td>
                                                    <td><button type="button" onclick="componentIssueModal(12,247)" class="btn btn-sm btn-primary pull-right">Quitar</button></td>
                                                </tr>
                                            </tbody>         
                                        </table>
                                    </div><!--./tableFixHead--> 
                    ...
                    <div class="tab-pane" id="timeline">
                        <!------------------------------------Incapacidad------------------------- -->
                        <div class="box-tab-header">
                            <div style="background-color:#d5d5d5;padding:2px !important;border-radius:7px; color:#000;!important;">
                              ...
                              <form method="post" action="<?= base_url('admin/Patient/saveInability/'.$result['result']["patient_id"].'/'.$result['result']['id'])?>" onsubmit="return validarFormulario()">
                                <div class="col-12" style="margin-left:10px;">
                                    <div class="form-group">
                                        ...
                                        <div> 
                                            <div class="input-group" style="margin: 5px !important;">
                                                <span class="input-group-addon" style="border-radius: 10px 0px 0px 10px !important;">
                                                    <i class="fas fa-users"></i></span> 
                                                <input type="text" name="id_inability" id="id_inability" class="form-control" 
                                                       placeholder="" autocomplete="off" 
                                                       value="Nº de incapacidad  <?= $contador ?>" style="border-radius: 0px 10px 10px 0px !important; width:250px;">
                                                <span class="text-danger"></span>
                                            </div>
                                        </div> 
                                    </div>
                                    ...
                                    <div class="form-group" >
                                        <label>Fecha Inicial:</label>
                                          <div class="input-group" style="margin:;">
                                              ...
                                              <input type="date" name="inability_initial_date" id="myDateInput" class="form-control"  placeholder="" autocomplete="off" style="border-radius: 0px 10px 10px 0px !important;">
                                              <span class="text-danger"></span>
                                          </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div> 
                                          <div class="input-group" style="margin:;">
                                              ...
                                              <input type="date" name="inability_final_date" id="endDate" placeholder="" class="form-control" autocomplete="off" style="border-radius: 0px 10px 10px 0px !important;">
                                              <span class="text-danger"></span>
                                          </div>
                                    </div> 
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div> 
                                          <div class="input-group" style="margin:;">
                                              ...
                                              <input type="text" name="inability_duration" id="duracion" placeholder="Tiempo de Incapacidad" class="form-control" autocomplete="off" style="border-radius: 0px 10px 10px 0px !important;">
                                              <span class="text-danger"></span>
                                          </div>
                                    </div> 
                                </div>
                            ...
                            <div class="col-4 col-md-4 col-sm-4" style="margin-left:; margin-top: 15px; ">
                              <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <select name="inability_type_disability"  class="form-control" id="tipoIncapacidad " style="border-radius: 0px 10px 10px 0px !important;">
                           ...
                           <div class="col-4 col-md-4 col-sm-4" style="margin-left:; margin-top: 15px; ">
                              <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <select name="inability_classification"  class="form-control" id="clasificacion" style="border-radius: 0px 10px 10px 0px !important;">
                                        <option value="" selected hidden><?php echo $this->lang->line('select'); ?></option>
                          ...
                          <div class="col-4 col-md-4 col-sm-4" style="margin-left:; margin-top: 15px; ">
                              <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <select name="inability_diagnosis"  class="form-control" id="diagnostico" style="border-radius: 0px 10px 10px 0px !important;">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea style="height:50px"  name="inability_observation" class="form-control" id="Observaciones" ></textarea>
                            </div> 
                        </div>
                          <div class="col-sm-12" style="margin-top: 10px; margin-left:30px; margin-bottom:30px;">
                        <button  id="" type="submit" class='btn btn-primary btn-md ' style="text-align-last:end; border-radius:20px;">
                       <i class="fa fa-edit"></i>  Guardar </button>                                                       
                    </div>
                </form>   
                <!------------/.----------- -->
                <table id="citas" class="table table-striped table-bordered table-hover dt-responsive no-footer" style="width:100%; margin-top:300px;">
                  <thead>
                      <tr>
                          <th style="background-color:#D9EDF7; color:##D9EDF7; padding:10px;">Nº Incapacidad</th>
                          <th style="background-color:#D9EDF7; color:##D9EDF7; padding:10px;">Fecha Inicial</th>
                          <th style="background-color:#D9EDF7; color:##D9EDF7; padding:10px;">Fecha Final</th>
                          <th style="background-color:#D9EDF7; color:##D9EDF7; padding:10px;">Duración:</th>
                          <th style="background-color:#D9EDF7; color:##D9EDF7; padding:10px;">Tipo de Incapacidad</th>
                          <th style="background-color:#D9EDF7; color:##D9EDF7; padding:10px;">Clasificacion</th>
                          <th style="background-color:#D9EDF7; color:##D9EDF7; padding:10px;">Diagnóstico</th>
                          <th style="background-color:#D9EDF7; color:##D9EDF7; padding:10px;">Observaciones</th>
                          <th style="background-color:#D9EDF7; color:##D9EDF7; padding:10px;">Acciones</th>
                      </tr>
                  </thead>
                  <tbody>
                    ...
                    <input id="eupdateid" name="updateid" placeholder="" type="hidden" class="form-control" value="" />
                                <div class="row">
                                        <div class="d-flex row">
                                            ...
                                            <div  class="col-lg-4 col-md-4 col-sm-4">
                                                <div style="background-color: #373838; margin-bottom:15px;border-radius:8px;padding: 6px;" class="border border-primary">
                                                    <h4 class="modal-title text-center" style="color:#fff;margin: 10px;">Información Personal <i class="fa fa-user"></i></h4>
<!--                                                     <h6 class="card-subtitle text-muted text-center" style="margin-top: 0px;">Support card subtitle</h6> -->
                                        ...
                                        <div class="row" style="margin-right: 5px; margin-left: 5px;">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="guardian_name" id="eguardian_name" placeholder="" value="<?php echo set_value('guardian_name'); ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <div class="form-group">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="validity" id="insurance_validity" >
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input name="identification_number" id="edit_identification_number" placeholder="<?php echo set_value('identification_number'); ?>" class="form-control" value="<?php echo set_value('identification_number'); ?>" />
                                            </div> 
                                        </div>
                                            ...
                                            <div class="row">  
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="address"  class="form-control" id="eaddress">
                                                            <option value="" selected hidden><?php echo $this->lang->line('select'); ?></option>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="contact" id="emobileno" class="form-control" >
                                                            <option value="" selected hidden><?php echo $this->lang->line('select'); ?></option>
...
<!--                                                         <input type="text" name="dob" id="epatient_dob" placeholder="<?php echo set_value('dob'); ?>"  class="form-control date patient_dob" /> -->
                                                         <input type="text" name="dob"  placeholder="<?php echo set_value('dob'); ?>"  class="form-control date editpatient_dob" /><?php echo set_value('dob'); ?>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="" name="note" id="enote" class="form-control" value="<?php echo set_value('note'); ?>">
                                            </div>
                                        </div>   
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="email"><?php echo $this->lang->line('ocupation'); ?></label> 
                                                <input type="text" name="known_allergies" id="eknown_allergies" placeholder="" class="form-control" value="<?php echo set_value('known_allergies'); ?>">
                                            </div> 
                                        </div> 
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="insurance_id"><?php echo $this->lang->line("profession"); ?></label> 
                                                <input type="text" name="insurance_id" id="edit_insurance_id" placeholder="" class="form-control" value="<?php echo set_value('insurance_id'); ?>">
                                            </div> 
                                        </div>
                                        </div>  
...
function validarFormulario() {
        ...
        var idIncapacidad = document.getElementById('id_inability').value;
        var fechaInicial = document.getElementById('myDateInput').value;
        var fechaFinal = document.getElementById('endDate').value;
        var duracion = document.getElementById('duracion').value;
        var tipoIncapacidad = document.getElementById('inability_type_disability').value;
        var clasificacion = document.getElementById('inability_classification').value;
        var diagnostico = document.getElementById('inability_diagnosis').value;

        // Realizar las validaciones
        if (idIncapacidad === '') {
            alert('Por favor ingresa el número de incapacidad.');
        ...
        if (duracion === '') {
            alert('Por favor ingresa la duración de la incapacidad.');
            return false;
        }

        if (tipoIncapacidad === '') {
            alert('Por favor selecciona el tipo de incapacidad.');
            return false;
        }

        if (clasificacion === '') {
            alert('Por favor selecciona la clasificación de la incapacidad.');
            return false;
        }

        if (diagnostico === '') {
            alert('Por favor selecciona el diagnóstico de la incapacidad.');
            return false;
        }
          ...
          function cie_structure(){
            ...
            let ciediez = resp;
             ...
             for (let property of ciediez ) {
                  text += `<option value="${property.cie10} - ${property.descripcion_diagnostico}" >${property.cie10} - ${property.descripcion_diagnostico} </option>`;
                  text2 += `<li class="list-group-item list-hover">${property.cie10} - ${property.descripcion_diagnostico} - ${property.cie10} - ${property.descripcion_diagnostico}</li>`;
                } 
...
//         console.log("medicines");
     ...
     window.addEventListener('load', 
        ...
        $.ajax({
              url : "<?= base_url('');?>/uploads/json/medicamentos_1.json",
              type : 'GET',
              dataType : 'json',
              success : (resp) => {
                console.log(resp);
...
//     console.log(""):
    ...
    function filter_cups(){
        
        console.log("cups");
//         var input, filter, ul, li, a, i, txtValue;
//         input = document.getElementById("search_cups");
//         filter = input.value.toUpperCase();
//         ul = document.getElementById("demo1");
//         li = ul.getElementsByTagName("option");
//         for (i = 0; i < li.length; i++) {
