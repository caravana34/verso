                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools addmeeting">
                            <?php if ($this->rbac->hasPrivilege('opd_patient', 'can_add')) { ?>                
                                <a data-toggle="modal" id="add" onclick="holdModal('myModal')" class="btn btn-sm addpatient" style="background:#1563B0; color:#fff;border-radius: 5px;"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add_patient'); ?></a> 
                            <?php } ?> 
                    ...
                    <input id="eupdateid" name="updateid" placeholder="" type="hidden" class="form-control" value="" />
                                <div class="row">
                                        <div class="d-flex row">
                                            ...
                                            <div  class="col-lg-4 col-md-4 col-sm-4">
                                                <div style="background-color: #a2cddf; margin-bottom:15px;border-radius:8px;padding: 6px;" class="border border-primary">
                                                    <h4 class="modal-title text-center" style="color:#444;margin:0px;">Información Personal <i class="fa fa-user"></i></h4>
