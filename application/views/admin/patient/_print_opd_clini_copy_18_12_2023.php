  ...
  <div class="row">
        ...
        <div class="card-body">
          <div class="col-md-12">
            <div class="col-md-12" style="width: -webkit-fill-available;display:flex; margin:0px 0px 5px 0px; gap:9px;">
              <div class="col-lg-5 col-md-5 col-sm-5  mt-4 mb-4" style="padding:10px;border-radius:15px; border: 1px solid #9b9898; margin-bottom:10px;">
                <p>
              ...
              <div class="col-lg-7 col-md-7 col-sm-7  mt-4 mb-4" style="padding:10px; border-radius:15px; border: 1px solid #9b9898; margin-bottom:10px;">
                <div class="col-12 m-2">
                  <p style=" display: inline;">
          ...
          <div class="col-md-12" style="width: -webkit-fill-available; margin-bottom:5px;padding:10px;height:100px">
          ...
          <div class="col-md-12" style="width: -webkit-fill-available;margin-bottom:10px;padding:10px;height:110px">
           ...
           <div class="col-md-12" style="width: -webkit-fill-available;margin-bottom:10px;padding:10px;height:410px;">
            ...
            <div class="row" >
              ...
              <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <ul>
                  <?php if($s->custom_field_id == 77 || $s->custom_field_id == 76 || $s->custom_field_id == 75 || $s->custom_field_id == 78 || $s->custom_field_id == 79 ){?>
                  <li>
    ...
    <div class="col-md-12 print-area1" >
          ...
          <div class="col-md-12" style="width: -webkit-fill-available;margin-bottom:10px;padding:10px;">
            ...
            <div class="header_clini col-md-12 mb-2 img-responsive">
              <p class="text-center">Revisión Por sistemas</p>
            </div>   
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6">
          ...
          <div class="col-md-12" style="width: -webkit-fill-available; margin-bottom:10px;padding:10px;height:810px;">
            <div class="header_clini col-md-12 mb-2 img-responsive">
            ...
            <div class="row d-flex" style="justify-content:space-between">
              <div class="col-md-6">
                <?php foreach ($fields as $key =>$s): ?>
                <ul>
                  <?php if($s->custom_field_id == 19 || $s->custom_field_id == 38 || $s->custom_field_id == 37 || $s->custom_field_id == 18 || $s->custom_field_id == 49 || $s->custom_field_id == 36 || $s->custom_field_id == 83 || $s->custom_field_id == 84 || $s->custom_field_id == 85 || $s->custom_field_id == 86 || $s->custom_field_id == 39 ){?>
                  <li>
                    <p>
              ...
              <div class="col-md-6">
                <?php foreach ($fields as $key =>$s): ?>
                <ul>
                  <?php if($s->custom_field_id == 44 || $s->custom_field_id == 52 || $s->custom_field_id == 90 || $s->custom_field_id == 91 || $s->custom_field_id == 96 || $s->custom_field_id == 54 || $s->custom_field_id == 47 || $s->custom_field_id == 45 || $s->custom_field_id == 87 || $s->custom_field_id == 88 || $s->custom_field_id == 89){?>
                  <li>
                    <p>
                      <b class="items_text"> <?php space($s->custom_field_id); ?></b> -
                      <?php echo $s->field_value; ?>
    ...
    <div class="col-md-12 print-area1" >
      ...
      <div class="col-mds-12 mt-3 mt-4 mb-4" style=" margin:10px 0px 10px 0px;padding:10px;">
            <div class="col-md-12">
              ...
              <div class="col-md-12 m-2" style="height:150px;">
                <div class="col-md-6 m-2">
                  <ul>
                    <p  class="items_text"style=" display: inline;">Principio activo: </p>
                    <p style=" display: inline;">
                    <?= $value->footer_note ?>
                    </p><br>

                    <p  class="items_text"style=" display: inline;">Concentración: </p>
                    <p style=" display: inline;">
                    <?= $value->finding_description  ?>
                    </p><br>

                    <p  class="items_text"style=" display: inline;">Dosis</p>
                    <p style=" display: inline;">
                    <?= $value->dosage ?>
                    </p>
                   </ul>
                ...
                <div class="col-md-6 m-2">
                  <ul>
                    <p  class="items_text"style=" display: inline;">Periodicidad: </p>
                    <p style=" display: inline;">
                    ...
                    <p  class="items_text"style=" display: inline;">Indicaciones</p>
                    <p style=" display: inline;">
                      <?= $value->instruction ?>
                    </p>
                  </ul>
      ...
      <div class="col-md-12 m-2" style="height:280px;">
   ...
   <div class="col-md-12  print-area1" style="">
     ...
     <div class="col-md-12" style="width: -webkit-fill-available; margin-bottom:10px;padding:10px;">
      ...
      <div class="col-md-12 m-2 mb-4" style="height:500px;" >
      <div class="header_clini col-md-12 mb-2 img-responsive">
