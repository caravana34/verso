...
<div class="content-wrapper" >
    <section class="content">
         <div class="box box-primary">
            <div style="display: flex; align-items: center;">
                ...
                <button id="openModalBtnprint" class="btn btn-md print_opd_clini" data-opdid="<?= $opdid ?>">Imprimir</button>
                               ...
                               <ul class="nav nav-tabs navlistscroll">
                                  <li class="active">
                                      <a href="#overview" data-toggle="tab" aria-expanded="true">
                                          <i class="icon1 fa fa-th" style='font-size:20px;color:#1563B0;'></i>
                                          Visión general
                                      </a>
                                  </li>
                                    <li>
                                       <a href="#procedure_admision" data-toggle="tab" aria-expanded="true">
                                          <i class="icon1 fas fa-file-medical" style='font-size:20px;color:#1563B0;'></i> 
                                          Admisión
                                       </a>
                                  </li>
                                  <li>
                                      <a href="#procedure_transoperatorio" data-toggle="tab" aria-expanded="true">
                                        <i class= "icon1 far fa-address-book" style='font-size:20px;color:#1563B0'></i> 
                                        Transoperatorio
                                      </a>
                                  </li>
                                  <li class="">
                                      <a href="#procedure_postoperatorio" data-toggle="tab" aria-expanded="true">
                        ...
                        <div class="tab-pane tab-content-height active" id="overview">
                            <div class="row">
                              ...
                              <div class="row">
                                ...
                                <!--./col-lg-7-->
                                  ...
                                  <div class="row">
                                    ...
                                    <hr class="hr-panel-heading hr-10">
                                    <h5>
                                        <strong><i class="fas fa-search-plus"></i> Admisión</strong>
                                    </h5>
                                    <hr class="hr-panel-heading hr-10">
                                <div class="row">
                                    <!--./col-lg-5-->
                              ...
                              <!--./row-->
                                <hr class="hr-panel-heading hr-10">
                                <h5>
                                    <strong><i class="fas fa-running"></i> Pre Operatorio</strong>
                                </h5>
                                <hr class="hr-panel-heading hr-10">
                                ...
                                <hr class="hr-panel-heading hr-10">
                                <h5>
                                    <strong><i class="fas fa-running"></i> Trans Operatorio</strong>
                                </h5>
                                <hr class="hr-panel-heading hr-10">
                                <div class="row d-flex" style="justify-content:space-between">
                                    <div class="col-md-6">  
                                ...
                                <hr class="hr-panel-heading hr-10">
                                <h5>
                                    <strong><i class="fas fa-running"></i> Post Operatorio</strong>
                                </h5>
                                <hr class="hr-panel-heading hr-10">
                                <div class="row d-flex" style="justify-content:space-between">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="col-md-12 d-flex" style="line-height: normal;">
                                            ...
                                            <div class="col-md-6">
                                                <div class="text-center text-light">
                                                    <a href="#"  class="btn btn-md" style="background:#1563B0; color:#fff;border-radius: 30px;" onclick="add_equipo('<?php echo $opdid; ?>')" data-toggle="tooltip" data-original-title="Historia Clínica">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 " style="">
                                                    <ul>
                                                        <li class="">
                                                            ...
                                                            <p><strong>Vía: </strong><?php echo $ope_theatre['Via']; ?></p>
                                                            <p><strong>Lateralidad: </strong><?php echo $ope_theatre['Laterality']; ?></p>
                                                            <p><strong>Anestesiólogo: </strong><?php echo $anestesiologo[0]->name." ".$anestesiologo[0]->surname; ?></p>
                                                            <p><strong>Descripción De Anestecia: </strong><?php echo $ope_theatre['descrition_anaethesia']; ?></p>
                                                            <p><strong>Enfermero: </strong><?php echo $aux_enfermeria[0]->name." ".$aux_enfermeria[0]->surname; ?></p>
                                        ...
                                        <div class="col-md-12"> 
                                            ...
                                            <div class="box-header mb10 pl-0">
                                                <h3 class="text-uppercase bolds mt0 mb0 ptt10 pull-left font14">Notas de <?php echo $this->lang->line('operation'); ?></h3>
                                                <div class="pull-right">
                                                    <button type="button" class="btn" data-toggle="modal" data-target=".modalNotasOperacion" style="background:#1563b0;color:#fff;border-radius:15px;">
                                                        ver todas las notas de operaciona
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="box-header mb10 pl-0">
                                                 <div class="table-responsive">
                                                     <div style="overflow-y: scroll; height:450px; overflow-x: scroll; width:850px;">
                                                        <table class="table table-bordered table-striped mt-5 mb-5" id="signos_vitales">
                                                            <thead>
                                                                <tr>
                                                                    <th>Nº de registro</th>
                                                                    <th>Fecha</th>
                                                                    <th>Tip. de operación</th>
                                                                    <th>Des. procedimiento</th>
                                                                    <th>Des. anestesia</th>
                                                                    <th>sugerencias y conclusiones</th>
                                                                    <th>resultado</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <?php foreach ($operation_theatre as $key =>$ope_theatre): ?>
                                                                <tr>
                                                                    <td><?php echo $ope_theatre['id']; ?></td>
                                                                    <td><?php echo $ope_theatre['date']; ?></td>
                                                                    <td><?php echo $ope_theatre['operation_type']; ?></td>
                                                                    <td><?php echo $ope_theatre['remark']; ?></td>
                                                                    <td><?php echo $ope_theatre['descrition_anaethesia']; ?></td>
                                                                    <td><?php echo $ope_theatre['Surgery_conclusions']; ?></td>
                                                                    <td><?php echo $ope_theatre['result']; ?></td>                                                          
                                                                    <td>
                                                                        <input type="hidden" value="<?php echo $operation_theatre->id; ?>">
                                                                        <i class='fas fa-edit ml-2' style='font-size:18px;' onclick='editot(<?php echo $operation_theatre->id; ?>)' style='font-size:22px; padding:2px;' title="Actualizar"></i>
                                                                        <i class="fa fa-trash delete_signos_vitales" data-id="<?php echo $operation_theatre->id; ?>" style='font-size:22px; padding:2px;' title="Eliminar"></i>
                                                                    </td>
                                                                </tr>
                                                                <?php endforeach ?>
                                                            </tbody>
    ...
    <!--                                                         <?php if (!empty($operation_theatre)) { ?>
                                                     <table class="table table-striped table-bordered  mb0">
                                                        ...
                                                        <tbody> 
                                                         <?php for ($i=0; $i <$recent_record_count; $i++) { if (!empty($operation_theatre[$i])) { ?>  
                                                            <tr>    
                                                                ...
                                                                <td> 
                                                                    <a onclick="editot('<?php echo $operation_theatre[$i]["id"]; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title=""  data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                                        <i class="fa fa-pencil"></i>
                                                                    </a>  
                                                                </td>
                                                                <td><?php echo $operation_theatre[$i]['ass_consultant_1'] ?></td>
                                                            </tr>
                                                        <?php } }?>
                                                        </tbody>
                                                     </table>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <ul>
                                                    <li class="">
                                                        <strong>Notas de Enfermería</strong><br>
                                    ...
                                    <hr class="hr-panel-heading hr-10">
                                    <h5><strong><i class="fas fa-chart-area"></i> Analisis</strong></h5>
                                    <hr class="hr-panel-heading hr-10">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <ul>
                                                <li class="">DFDFGDGFD</li>
                                            </ul>  
                                        </div> 
                                    </div>
                        ...
                        <!-- -----------------------Admisión------------------------- -->
                        <div class="tab-pane tab-content-height " id="procedure_admision">
                                        ...
                                        <div class="col-lg-12 col-md-4 col-sm-12" style="overflow-y: scroll; height:450px;">
                                            <div class="box-tab-header">
                                                ...
                                                <div class="box-tab-tools">
                                                     <button type="button" class="btn" data-toggle="modal" data-target=".bd-example-modal-lg" style="background:#1563b0;color:#fff;border-radius:15px;">
                                        ...
                                        <table class="table table-bordered table-striped mt-5 mb-5" id="signos_vitales">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Talla</th>
                                                    <th>Temperaturas</th>
                                                    <th>Pres. Diastólica</th>
                                                    <th>Pres. Sistólicaa</th>
                                                    <th>Frec. Cardíaca</th>
                                    ...
                                    <div class="tab-pane tab-content-height" id="Medicamentos">
                                        <div class="box-tab-header mb-2" style="margin-top:40px;">
                                            <h3 class="box-tab-title" style="color:#1563B0;">
                                                ...
                                                <strong>Notas Medicamnetos</strong>
                                            </h3>
                                            <div class="box-tab-tools">
                                                 <button type="button" class="btn" data-toggle="modal" data-target=".bd-example-modal-lg" style="background:#1563b0;color:#fff;border-radius:15px;">
                                                    Registros de cirugía
                        ...
                        <div class="tab-pane tab-content-height" id="procedure_transoperatorio">
                            <div class="box-tab-header">
                                ...
                                <div class="box-tab-tools">
        <!--                                     <a href="#" class="btn btn-sm btn-primary dropdown-toggle addprescription" data-toggle="modal">
        ...
        <!--                             <div>
                                <button type="button" class="btn" data-toggle="modal" data-target=".bd-example-modal-lg" style="background:#1563b0;color:#fff;border-radius:15px;">Regitros de cirugía</button>
                            </div> -->
                ...
                <div class="col-md-12 itemcol">
                    <div class="nav-tabs-custom relative" style="margin:20px">
                        <ul class="nav nav-tabs">
                            ...
                            <li>
                                <a href="#Signos_Vitales_admision"  data-toggle="tab" aria-expanded="true">
                                    <i class="fas fa-heartbeat" style='font-size:15px;color:#1563B0;'></i> Signos Vitales
                                </a>
                            </li>
                            <li>
                                <a href="#Medicamentos1"  data-toggle="tab" aria-expanded="true">
                        ...
                        <div class="tab-content pt6" style="margin:10px;">
                            <!-- --Signos_Vitales--------- -->
                            <div class="tab-pane tab-content-height" id="Signos_Vitales_admision">
                            ...
                            <div class="row" style="margin: 0px;padding: 0px;">
                                ...
                                <!------ADMICION--Medicamentos------ -->
                            <div class="tab-pane tab-content-height" id="Medicamentos1">
                                <div class="box-tab-tools">
<!--                                     <a href="#" class="btn btn-sm btn-primary dropdown-toggle addmedication" onclick="addmedicationModal()" data-toggle="modal">
                                        <i class="fa fa-plus"></i> Agregar dosis de medicamento
                                    </a> -->
  ...
  <div class="modal-dialog" style="width: 1300px;" >
    <div class="modal-content">
        <div class="modal-header modal-media-header">
            ...
            <h4 class="modal-title">Notas Quirurgicas</h4> 
        </div>
        <div class="modal-body ">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 " style="border: solid 0.5px #1563b0; border-radius:15px; margin:10px; padding:5px; margin-left:90;">
                    <ul>
                        <li class="">
                            ...
                            <p><strong>Anesteciologo: </strong><?php echo $ope_theatre['anesthetist']; ?></p>
                            <p><strong>Descripción De Anestecia: </strong><?php echo $ope_theatre['descrition_anaethesia']; ?></p>
