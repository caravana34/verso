                ...
                <div class="nav-tabs-custom relative">
                      ...
                      <div style="display: flex; align-items: center;">
                        <div class="col-md-7">
                          ...
                          <h5>
                            <span class="mt-5" style="margin-right: 5px;"><strong>Fecha:</strong> <?php echo $doctor_app[0]->date; ?></span>
                            <span class="mt-5" style="margin-right: 5px;"><strong>Hora de inicio:</strong> <?= $start_time." - <strong>Hora final:</strong> ".$fecha->format('h:i:s A') ?></span>
                            <span <?= $result_time = $result['result']['refference']=="Abierta" ? "" : "hidden" ?> class="mt-5" style="margin-right: 5px;" id="time_progress"></span>
                          </h5>
                          <!-- <?php  // $doctor_duration[0]->consult_duration;?> - <?php//  date_default_timezone_set("America/Bogota"); echo "The time is " . date("h:i:sa");
                           // $result = date("H/i/s", mktime(date("H"), date("i") + $doctor_duration[0]->consult_duration, date("s")));
                          ?> -->
                        </div>
                  ...
                  <!-- readonly
                        ...
                        <div class="" style="position: absolute; right: 10px;">
                          <button onclick="confirmar_opd('<?=$result['result']['id']?>', '<?=$id?>', '<?=$id_visit[0]->id?>')" id="confirmar" class="btn btn-danger btn-sm mt-5"<?=$result_state_disabled?> type="button"><?= $result_state = $result['result']['refference']=="Abierta" ? "Terminar" : "Terminado" ?></button>
                        </div>
                    ...
                    <ul class="nav nav-tabs navlistscroll" style="border-top: 1px solid #ddd; margin-top: 5px;">
                        ...
                        <li><a href="#operationtheatre" data-toggle="tab" aria-expanded="true"><i class="fas fa-notes-medical"></i> Procedimientos</a></li>
                        ...
                        <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 border-r">
                                    ...
                                    <div class="box-header border-b mb10 pl-0" style="padding: 12px;">
                                        <h3 class="text-uppercase bolds mt0 ptt10 pull-left font14" style="margin-right: 20px;"><?php echo $result['result']['patient_name'] ;?> <?php echo $result['result']['guardian_name'] ;?> <?php echo $result['result']['id'] ;?></h3>
                                        <div class="pull-right">
                                            <a href="<?php echo base_url() . "admin/patient/profile/" . $result['result']["patient_id"] . "/" . $result['result']["id"] ?>" id="" class="btn btn-md revisitpatient" style="background:#1563B0; color:#fff;border-radius: 30px;" data-toggle="tooltip" title="Perfil">
...
<!--                                                         <td class="bolds"><?php echo $this->lang->line('phone'); ?></td> -->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                ...
                                                <table class="table table-bordered mb0">
                                                    ...
                                                    <ul>
                                                        <li><?= $doctor_app[0]->reason_consultation ?></li>
                                                    </ul>
                                     ...
                                     <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                              ...
                                              <?php foreach ($result['custom'] as $key =>$s): ?>
                                                    <ul>
                                                        <?php if($s->custom_field_id == 77 || $s->custom_field_id == 76){?>
                                                        
                                                        <li> <p> <?php space($s->custom_field_id); ?>: <?php echo $s->field_value; ?></p></li>
                                                        <?php } ?>
                                                    </ul>
                                      ...
                                      <div class="row">
                                           <div class="col-lg-12 col-md-12 col-sm-12">
                                               ...
                                               <?php foreach ($result['custom'] as $key =>$s): ?>
                                                    <ul>
                                                        <?php if($s->custom_field_id == 75 || $s->custom_field_id == 78){?>
                                    ...
                                    <hr class="hr-panel-heading hr-10">
                                     ...
                                     <div class="row d-flex" style="justify-content:space-between">
                                         <div class="col-md-6">
                                             <?php foreach ($result['custom'] as $key =>$s): ?>
                                            <ul>
                                             <?php if($s->custom_field_id == 19 || $s->custom_field_id == 38 || $s->custom_field_id == 37 || $s->custom_field_id == 18 || $s->custom_field_id == 49 || $s->custom_field_id == 36){?>
                                               <li><p>
                                                    <b><?php space($s->custom_field_id); ?></b> - <?php echo $s->field_value; ?> <?php if($s->custom_field_id == 36){echo ("Kg");}elseif($s->custom_field_id == 49){echo ("°C");}elseif($s->custom_field_id == 19){echo ("Cm");}elseif($s->custom_field_id == 38){echo ("LPM");} ?>
                                                </p></li> 
                                             <?php } ?>
                                           </ul>
                                             <?php endforeach ?>
                                         ...
                                         <div class="col-md-6">
                                             <?php foreach ($result['custom'] as $key =>$s): ?>
                                           <ul>
                                             <?php if($s->custom_field_id == 39 || $s->custom_field_id == 44 || $s->custom_field_id == 52 || $s->custom_field_id == 54 || $s->custom_field_id == 47 || $s->custom_field_id == 45){?>
                                               <li>  <p>
                                                   <b> <?php space($s->custom_field_id); ?></b> - <?php echo $s->field_value; ?> <?php if($s->custom_field_id == 39){echo ("RPM");}elseif($s->custom_field_id == 44 || $s->custom_field_id == 45){echo ("mmHg");}?>
                                                </p>
                                             </li>
                                             <?php } ?>
                                             </ul>
                                      ...
                                      <hr class="hr-panel-heading hr-10">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                             ...
                                             <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <?php foreach ($result['custom'] as $key =>$s): ?>
                                                    <ul>
                                                        <?php if($s->custom_field_id == 62 ){?>
                                                        <li class="">
                                                         <strong><?php space($s->custom_field_id); ?></strong><br><?php echo $s->field_value; ?>
                                                       </li>
                                                        <?php } ?>
                                                    </ul>
                                                    <?php endforeach ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                    ...
                                                    <?php foreach ($result['custom'] as $key =>$s): ?>
                                                    <ul>
                                                        <?php if( $s->custom_field_id == 74){?>
                                                        <li class="">
                                                        <strong><?php space($s->custom_field_id); ?></strong><br><?php  $tipo_d2 = explode("-", $s->field_value); echo $tipo_d2[0]."-".$tipo_d2[1]; ?>
                                                       </li>
<!--                                                        <td></td> -->
                                                        <?php } ?>
                                                    </ul>
                                           ...
                                           <div class="col-lg-6 col-md-6 col-sm-6">
                                                    ...
                                                    <ul>
                                                        <?php if( $s->custom_field_id == 74){?>
                                                        <li class="">
                                                        <strong><?php space($s->custom_field_id); ?></strong><br><?php  $tipo_d2 = explode("-", $s->field_value); echo $tipo_d2[2]; ?>
                                                       </li>
<!--                                                        <td></td> -->
                                                        <?php } ?>
                                                    </ul>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                              <div class="box-header border-b mb10 pl-0" style="padding: 12px;">
                                  ...
                                  <h3 class="text-uppercase mt0 ptt10 pull-left font14"><?php echo $result['result']['name'] ?>  <?php echo $result['result']['surname'] ?></h3>
                                  <div class="pull-right">
                                  ...
                                  <div class="pull-right">
                                       <div class="text-center text-light">
                                          <?php if ($this->rbac->hasPrivilege('opd_patient', 'can_edit')) { ?>
                                                <a href="#"  class="btn btn-md revisitpatient <?=$result_state_disabled?>"  onclick="editRecord('<?php echo $id_visit[0]->id; ?>')" style="background:#1563B0; color:#fff;border-radius: 30px;" data-target="#revisitModal" data-toggle="tooltip" data-original-title="Historia Clínica"><i class="fa fa-stethoscope"></i>  Consulta</a>
  ...
  <!--                                                            <a data-toggle="tooltip" class="" onclick="discharge_revert('<?php echo $result['case_reference_id']; ?>')" href="#" title="<?php echo $this->lang->line('discharge_revert')?>"><i class="fa fa-undo"> </i></a> -->
                        ...
                        <div class="tab-pane" id="operationtheatre">
                            <div class="box-tab-header" style="border: none !important; margin: 0px !important;">
                             ...
                             <form id="add_procedure" method="post" accept-charset="utf-8" class="ptt10">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control mt-2 " id="" name="" autocomplete="off" style="border-radius: 0px 10px 10px 0px !important;" <?=$result_state_readonly?>>
                                              ...
                                              <?php elseif($s->custom_field_id == 74): ?>
                                                <option value="<?php $diag =explode("-", $s->field_value); echo ($diag[0]."-".$diag[1]); ?>"><?php $diag =explode("-", $s->field_value); echo ($diag[0]."-".$diag[1]); ?></option>
                                               <?php endif ?>
                                              <?php endforeach ?>
                                            </select>
                                        </div>
                              ...
                              <div class="col-lg-6" style="margin-top: 10px !important;">
                                   <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon" style="border-radius: 10px 0px 0px 10px !important;"><i class="fas fa-stethoscope"></i></span> 
                                            <select class="form-control mt-2 " name="specialities_procedure" autocomplete="off" style="border-radius: 0px 10px 10px 0px !important;" <?=$result_state_readonly?>>
                                               <option value="" hidden>Opciones</option>
                                  ...
                                  <div class="col-lg-6 col-md-4 col-sm-4">
                                      <div class="form-group">
                                         <label>Destino</label>
                                          <div class="input-group">
                                              <span class="input-group-addon" style="border-radius: 10px 0px 0px 10px !important;"><i class="fa fa-search"></i></span> 
                                              <input type="text" class="form-control search_text" id="lname" onkeyup="busqueda()" placeholder="Buscar procedimiento" autocomplete="off" style="border-radius: 0px 10px 10px 0px !important;" <?=$result_state_readonly?>>
                                              <span class="text-danger"></span>
                                          </div> 
                                      </div>
                                       <div class="usersearchlist">
                                          <ul class="list-group scroll-container mb-3" style="position: absolute; z-index: 100;" id="cups" hidden>        
                                          </ul>
                                       </div>
                                   </div>
                                     ...
                                     <div class="col-lg-2 col-md-4 col-sm-4">
                                        <div class="form-group">
                                           ...
                                           <div class="input-group">
                                              ...
                                              <input type="text" class="form-control" autocomplete="off" id="" name="quantity_procedure" placeholder="" style="border-radius: 0px 10px 10px 0px !important;" <?=$result_state_readonly?>>
                                              <span class="text-danger"></span>
                                          </div>
                                        </div>
                                     </div>
                                                                ...
                                                                <tbody>
                                                                  <?php foreach($procedures_opd as $key => $value): ?>
                                                                      <tr>
                                                                            ...
                                                                            <td><?= $value->specialities ?></td>
                                                                            <td><?= $value->procedure_cant ?></td>
                                                                        </tr>
                                                                  <?php endforeach ?>
                                                                 </tbody>
                                                            </table>
                       ...
                       <form id="insert_medication" accept-charset="utf-8" class="ptt10"> 
                          ...
                          <div class="row" style="padding-top: 12px;">
                            <div class="col-lg-6" style="margin-top: 10px !important;">
                             ...
                             <div class="usersearchlist">
                                <ul class="list-group scroll-container mb-3" style="position: absolute; z-index: 100;" id="medicines_pbs" hidden>        
                                </ul>
                             </div>
                           </div> 
                           ...
                           <div class="col-lg-6" style="margin-top: 10px !important;">
                             <div class="mt-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" style="border-radius: 10px 0px 0px 10px !important;"><i class="fa fa-search"></i></span> 
                                    <input type="text" class="form-control search_text" id="search_medicine" onkeyup="medication_structure()" placeholder="Buscar medicamento" autocomplete="off" style="border-radius: 0px 10px 10px 0px !important;" <?=$result_state_readonly?>>
                                    <span class="text-danger"></span>
                                </div> 
                             </div>
                             <div class="usersearchlist">
                                <ul class="list-group scroll-container mb-3" style="position: absolute; z-index: 100;" id="medicines" hidden>        
                                </ul>
                             </div>
                           </div> 
                            
                            <div class="col-lg-6" style="margin-top: 10px !important;">
                                 <div class="form-group select-conteiner">
...
<!--                            <div class="col-lg-12 mb-5 pd-0" style="margin-bottom: 15px; padding: 0px;">
                              ...
                              <div class="col-sm-12">
                                <div class="form-group">
                                  ...
                                  <textarea name="medication_indication" class="form-control" name="medicine_indication" autocomplete="off" style="resize: none;" <?=$result_state_readonly?>></textarea>
                                </div>
                              </div>
                                    ...
                                    <div class="form-group" >
                                        <label>Fecha Inicial:</label>
                                          <div class="input-group" style="margin:;">
                                              ...
                                              <input type="date" name="inability_initial_date" id="myDateInput" class="form-control"  placeholder="" autocomplete="off" style="border-radius: 0px 10px 10px 0px !important;" <?=$result_state_readonly?>>
                                              <span class="text-danger"></span>
                                          </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div> 
                                          <div class="input-group" style="margin:;">
                                              ...
                                              <input type="text" name="inability_duration" id="duracion" placeholder="Tiempo de Incapacidad" class="form-control" autocomplete="off" style="border-radius: 0px 10px 10px 0px !important;" <?=$result_state_readonly?>>
                                              <span class="text-danger"></span>
                                          </div>
                                           <p class="text-danger" id="pDuracion" style="display:none;">Necesita una duración*</p>
                                    </div> 
                                </div>
                            </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <select name="inability_type_disability"  class="form-control" id="tipoIncapacidad" style="border-radius: 0px 10px 10px 0px !important;" <?=$result_state_readonly?>>
                                        ...
                                        <option value="02: Efermedad Profecional" >Enfermedad Profesional</option>
                   ...
                   <div class="tab-pane" id="remisions">
                        ...
                        <div class="box-tab-header">
                          ...
                          <div class="row">
                            <div class="col-lg-6" style="margin-top: 10px !important;">
                                 <div class="form-group select-conteiner">
                                    <label>Diagnosticos principales</label>
                                    <div class="input-group">
                                      <span class="input-group-addon" style="border-radius: 10px 0px 0px 10px !important;"><i class="fas fa-stethoscope"></i></span> 
                                      <select class="form-control mt-2 " id="" name="diagnosis_main" autocomplete="off" style="border-radius: 0px 10px 10px 0px !important;" <?=$result_state_readonly?>>
                                         <option value="" hidden>Diagnosticos</option>
                                        <?php foreach ($result['custom'] as $key =>$s): ?>
                                        <?php if($s->custom_field_id == 29 || $s->custom_field_id == 58 || $s->custom_field_id == 59):?>
                                          <option value="<?= $s->field_value; ?>"><?= $s->field_value; ?></option>
                                         <?php endif ?>
                                        <?php endforeach ?>
                                      </select>
                           ...
                           <div class="col-lg-6" style="padding-top: 10px !important;">
                                <div class="form-group">
                                    <label>Diagnosticos presuntos</label>
                                    <div class="input-group">
                                        <span class="input-group-addon" style="border-radius: 10px 0px 0px 10px !important;"><i class="fas fa-diagnoses"></i></span> 
                                        <select class="form-control mt-2 " id="" name="diagnosis_presumed" autocomplete="off" style="border-radius: 0px 10px 10px 0px !important;" <?=$result_state_readonly?>>
                                           <option value="" hidden>Diagnosticos</option>
                           ...
                           <div class="col-lg-12 mb-5 pd-0" style="margin-bottom: 15px; padding: 0px;">
                               <div class="col-lg-6">
                                 <div class="mt-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon" style="border-radius: 10px 0px 0px 10px !important;"><i class="fa fa-search"></i></span> 
                                        <input type="text" class="form-control search_text" id="benefits_search" onkeyup="busqueda()" placeholder="Buscar prestación" autocomplete="off" style="border-radius: 0px 10px 10px 0px !important;" <?=$result_state_readonly?>>
                                        <span class="text-danger"></span>
                                    </div> 
                                </div>
                                 <div class="usersearchlist">
                                    <ul class="list-group scroll-container mb-3" style="position: absolute; z-index: 100;" id="benefits" hidden>        
                                    </ul>
                                 </div>
                               </div>
                             
                                <div class="col-lg-6">
                                    <div class="form-group" style="margin-bottom: 15px; padding: 0px; margin-left: 15px; margin-top: 15px;">

                                          <label class="pr20 d-md-block">Tipo:</label>

                                              <label class="radio-inline">
                                                  <input type="radio" value="standard" name="content_category" checked="checked" <?=$result_state_disabled?>> Remision</label>

                                              <label class="radio-inline">
                                                  <input type="radio" value="events" name="content_category" autocomplete="off" <?=$result_state_disabled?>> Interconsulta</label>
                             ...
                             <div class="modal-footer">
                                <div class="pull-right">
                                    <button type="submit" class="btn pull-right" style="background:#1563b0; color:#fff;" autocomplete="off" <?=$result_state_disabled ?>><i class="fa fa-check-circle"></i> Guardar</button>
                                </div>
                            </div>
                                                    ...
                                                    <div class="form-group">
                                                       <label><?php echo $this->lang->line('consultant_doctor'); ?></label><small class="req"> *</small> 
                                                            <select  onchange="" name="consultant_doctor" <?php
                                                                ...
                                                                ?> style="width:100%" class="form-control select2" id="edit_consdocto">
                                                                <option value=""><?php echo $this->lang->line('select'); ?></option>
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="modal-title">Terminar cita</h4> 
            </div>
             <form id="status_opd" accept-charset="utf-8" method="post" class="ptt10">
              <div class="modal-body pt0 pb0">
                   <strong class="mb-3">
                     ¿Desea terminar la atención para el paciente?
                   </strong>
                    <p>
                      Antes de considerar la firma, revisa minuciosamente la información en la historia clínica para asegurarte de que todos los detalles relevantes estén registrados de manera precisa. Esto incluye síntomas, diagnósticos, tratamientos, medicamentos, resultados de exámenes y cualquier otra información pertinente.
                    </p>
                   <div class="row">
                      <div class="form-group">
                          <label class="col-sm-4 control-label">Firmar Historia Clínica</label>
                          <div class="col-sm-8">
                              <div class="material-switch" id="check_status">
                                  <input name="signed_checkbox" type="checkbox" class="chk" value="0">
                                  <label class="label-success"></label>
                              </div>
                          </div>
                      </div>
                       <div id="signed_checkbox" class="col-lg-12" style="display: none;">  
                            <div class="form-group">
                                <label>Firma digital</label>
                                 <div class="input-group">
                                    <span class="input-group-addon" style="border-radius: 10px 0px 0px 10px !important;"><i class="fas fa-prescription-bottle-alt"></i></span> 
                                    <input type="text" class="form-control" autocomplete="off" name="signed_appointment" placeholder="" style="border-radius: 0px 10px 10px 0px !important;">
                                 </div>
                                 <label for="exampleInputFile">Firma digital</label>
                                  <div>
                                    <div class="dropify-wrapper"><div class="dropify-message"><p><i class="fa fa-cloud-upload dropi18"></i>Drop a file here or click</p><p class="dropify-error">Ooops, something wrong appended.</p></div><div class="dropify-loader" style="display: none;"></div><div class="dropify-errors-container"><ul></ul></div><input class="filestyle form-control" type="file" name="file" id="file" size="20" data-height="26" autocomplete="off"><button type="button" class="dropify-clear">Remove</button><div class="dropify-preview" style="display: none;"><span class="dropify-render"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-filename"><span class="file-icon"></span> <span class="dropify-filename-inner"></span></p><p class="dropify-infos-message">Drag and drop or click to replace</p></div></div></div></div>
                                  </div>
                                  <span class="text-danger"></span>
                            </div>
                       </div>
                 ...
                 <div class="modal-footer">
                    <button type="submit" id="status_opd_btn" data-loading-text="<?php echo $this->lang->line('processing'); ?>" style="margin-left: 10px; color:#fff; background:#1563B0 !important;" class="btn btn-info pull-right">Terminar</button>
                                        ...
                                        <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <label for="consultant_doctor">
                                                        <?php echo $this->lang->line('consultant_doctor'); ?></label><small class="req"> *</small>
                                                    <div><select name='consultant_doctor' id="edit_consdoctor" class="form-control select2" <?php
                                                        if ($disable_option == true) {
                                                            echo "disabled";
                                                        }
...
<!--                                             <div class="col-md-6">
            ...
            <div class="box-footer sticky-footer">
                    ...
                    <div class="pull-right">
                        <button type="submit" id="formeditbtn" name="save" data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn btn-info pull-right" style="background:#1563B0 !important; color:#fff;"><i class="fa fa-check-circle" ></i> <span><?php echo $this->lang->line('save'); ?></span></button>
                    </div>

                    <div class="pull-right" style="margin-right: 10px; ">
                        <button type="submit"  data-loading-text="<?php echo $this->lang->line('processing') ?>" name="save_print" class="btn btn-info pull-right printsavebtn" style="background:#1563B0 !important; color:#fff;"><i class="fa fa-print"></i> <?php echo $this->lang->line('save_print'); ?></button>
                    </div>
            </div>
            </form> 
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
      ...
      $(document).ready(function (e) {
        $("#insert_medication").on('submit', (function (e) {
            ...
            $.ajax({
                url: "<?= base_url('admin/Patient/add_opd_prescription/'.$result['result']["patient_id"].'/'.$id_visit[0]->id.'/'.$result['result']['id'])?>",
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
    ...
    $(document).ready(function (e) {    
      $("#add_procedure").on('submit', (function (e) {
          ...
          $.ajax({
              url: "<?= base_url('admin/Patient/insert_procedure/'.$result['result']["patient_id"].'/'.$id_visit[0]->id.'/'.$result['result']['id'])?>",
              type: "POST",
              data: new FormData(this),
              dataType: 'json',
              contentType: false,
     ...
     function removeDuplicatesMedicines(array) {
      ...
      function pbs_medications(){
        ...
        let medicines_result = document.getElementById("medicines_pbs");
          $.ajax({
            url: `https://www.datos.gov.co/resource/a7iv-sme8.json?$where=atc%20like%20'%25${input_medicines_pbs}%25'%20OR%20principioactivo%20like%20'%25${input_medicines_pbs}%25'%20OR%20descripcionatc%20like%20'%25${input_medicines_pbs}%25'%20OR%20concentracion%20like%20'%25${input_medicines_pbs}%25'&$limit=10&$offset=0`,
            type : 'GET',
            dataType : 'json',
            data: {
                ...
                for (let property of medicines_pbs){
                      medicines_list_pbs += `<li class="list-group-item list-hover" onclick="addMedication({expediente:'${property.expediente}',
                                      ...
                                      <div class="col-xs-10 col-sm-9">
                                          <span class="name"><strong>Codigo atc: </strong>${property.atc}</span><br>
                                          <span class="name"><strong>Principio activo: </strong>${property.principioactivo}</span><br>
                                          <span class="name"><strong>Principio activo min: </strong>${property.unidadreferencia}</span><br>
                                      </div>
...
//                   successMsg(data.message);
        ...
        const targetElement = event.target;
            ...
            if (targetElement !== input_medicines && medicines.contains(targetElement)) {
        ...
        let trade_name = document.getElementById('trade_name');
         ...
         concentration.value = `${cantidad} ${unidadmedida}`;
         form_pharmaceutical.value = `${formafarmaceutica}`;
         medication_through.value = `${viaadministracion}`;
 ...
 <script type="text/javascript">
  ...
  function confirmar_opd(id_user, id_opd, id_visit){
      ...
      $(document).ready(function () {
        ...
        const inputElement = check_status.querySelector("input.chk");
        ...
        check_status.addEventListener('click', function () {
            if(inputElement.value == '0'){
              ...
              signed_checkbox.style.display = 'block';
            } else {
              inputElement.checked = false;
              inputElement.value = "0";
              signed_checkbox.style.display = 'none';
            }
        });
                ...
                $.ajax({
                  ...
                  success: function (resp) {
                    ...
                    if (resp.status == "fail"){
                       errorMsg(resp.errors.signed_appointment);  
                    } else {
