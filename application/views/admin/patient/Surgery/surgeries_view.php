            ...
            <div class="col-md-12">
                <div class="box box-primary"> 
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix">Cirugías</h3>
...
<script type="text/javascript">
     ...
     $("#rescheduleform").on('submit', function (e) {
          ...
          let edit_status = document.getElementById('edit_appointment_status').value;
...
//    }
   ...
   function enviar_fecha_parametros(){ 
        ...
        if(fecha_inicial != '' && fecha_final != ''){
            ...
            initDatatable('ajaxlist',`admin/appointment/get_appointment_datatable/${fecha_inicial}/${fecha_final}/${doctor_id}/?view=${encodeURIComponent(view)}`,[],[],25);
        }else{
  ...
  function viewDetail(id) {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          } else if (data.appointment_status == "No Asistida") {
            var text = "No Asistida";
            var label = "class='label cita_no_asistida'";  
          }
