                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('income', 'can_add')) {?>
                                <a data-toggle="modal" data-target="#myModal" class="btn btn-sm addincome"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add_income'); ?></a>
                            <?php }?>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header" style="background:linear-gradient(#b7b5b3, #7c7b7a); color:#fff;">
                <button type="button" class=" btn close" data-dismiss="modal">&times;</button>
                <h4 class="" style="color:#fff;"><?php echo $this->lang->line('add_income'); ?></h4>
            </div>
            <form id="add_income" class="ptt10" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <div class="pull-right">
                        <button type="submit" id="add_incomebtn" data-loading-text="<?php echo $this->lang->line('processing'); ?>" class="btn pull-right"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                    </div>
                </div>
             </form>
        </div>
