            ...
            <aside class="studentsidebar">
                <div  class="stutop" id="">
                    ...
                    <div class="studentsidetopfixed">
                        <p class="classtap" style="background:#1563b0; color:#fff;"><?php echo $this->lang->line('staff'); ?> 
                            <a href="#" data-toggle="control-sidebar" class="studentsideclose"><i class="fa fa-times"></i>
                            </a>
                        </p>
                    ...
                    <div class="tab-content">
                        <?php foreach ($roles as $rolet_key => $rolet_value) { ?>
                            <div class="tab-pane <?php if ($staff["role_id"] == $rolet_value["id"]) { echo "active";}?>"  
                                      ...
                                      ?>
                                        <div class="studentname">
                                            <a  href="<?php echo base_url("admin/staff/profile/" . $svalue["id"]); ?>">
                                                ...
                                                <div class="student-tittle" style="color:#1563b0;">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('staff_date_of_leaving'); ?></b> 
                                  <a class="pull-right text-aqua">
                                  <?php if ($staff["date_of_leaving"] != '0000-00-00') {
...
?>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <div class="staffprofile">
                                        ...
                                        <div class="icon mt12font40">
                                            <i class="fa fa-money" style="color:#1563b0"></i>
                                        </div>
                                    </div>
                                </div><!--./col-md-3-->
                                <div class="col-lg-3 col-md-6 col-sm-6">
                        ...
                        <div class="tab-pane" id="timeline">
                            <div><?php if ($this->rbac->hasPrivilege('staff_timeline', 'can_add')) {?>
                                    <button id="myTimelineButton"  class="btn btn-sm pull-right" style="background:#1563B0; color:#fff;">
                                    ...
                                    ?>
                                        <ul class="timeline timeline-inverse">
                                            <?php foreach ($timeline_list as $key => $value) { ?>
                                                <li class="time-label">
                                                    <span class="bg-blue">
                                                        <?php echo $this->customlib->YYYYMMDDTodateFormat($value['timeline_date']);?>
                                                    </span>
                                                </li>
                                                <li>
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-sm-6 col20per">
                                    <div class="staffprofile">
                                        ...
                                        <div class="icon">
                                            <i class="fa  fa-check-square-o" style="color:#1563b0;"></i>
                                        </div>
                                    </div>
                                </div>
                                <!--./col-md-3-->
...
<div class="modal fade" id="myTimelineModal" role="dialog">
    <div class="modal-dialog modal-sm400">
        <div class="modal-content">
            <div class="modal-header" style=" background:linear-gradient(#b7b5b3, #7c7b7a);">
                <button type="button" class="close"  style="color:#1563b0;" data-dismiss="modal">&times;</button>
                ...
                <form id="timelineform" name="timelineform" method="post" action="<?php echo base_url() . "admin/timeline/add_staff_timeline" ?>" enctype="multipart/form-data" class="ptt10">
                    <div class="modal-body pt0 pb0">
                        ...
                        <div class="modal-footer">
                            <button type="submit" id='timelinebtn' data-loading-text="<?php echo $this->lang->line('processing'); ?>" style="background:#1563b0; color:#fff;" class="btn pull-right"><?php echo $this->lang->line('save'); ?></button>
                        </div>
                </form>  
            </div>
        </div>
    ...
    $(document).ready(function () {
        $("#attendancetable").DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'copyHtml5',
                    text: '<i class="fa fa-files-o" style="color:#1563B0;"></i>',
                    titleAttr: 'Copy',
                ...
                {
                    extend: 'excelHtml5',
                    text: '<i class="fa fa-file-excel-o" style="color:#1563B0;"></i>',
                    titleAttr: 'Excel',
                    title: $('.download_label').html(),
                    exportOptions: {
                        columns: ':visible'
                ...
                {
                    extend: 'csvHtml5',
                    text: '<i class="fa fa-file-text-o" style="color:#1563B0;"></i>',
                    titleAttr: 'CSV',
                    title: $('.download_label').html(),
                    exportOptions: {
                        columns: ':visible'
                ...
                {
                    extend: 'pdfHtml5',
                    text: '<i class="fa fa-file-pdf-o" style="color:#1563B0;"></i>',
                    titleAttr: 'PDF',
                    title: $('.download_label').html(),
                    exportOptions: {
                        columns: ':visible'
                ...
                {
                    extend: 'print',
                    text: '<i class="fa fa-print" style="color:#1563B0;"></i>',
                    titleAttr: 'Print',
                    title: $('.download_label').html(),
                ...
                {
                    extend: 'colvis',
                    text: '<i class="fa fa-columns" style="color:#1563B0;"></i>',
                    titleAttr: 'Columns',
                    title: $('.download_label').html(),
