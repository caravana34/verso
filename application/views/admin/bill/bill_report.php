            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Maestro de facturas</h3>
                    </div>
...
( function ( $ ) {
    ...
    $(document).ready(function () {
       ...
       $('#form1').on('submit', (function (e) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>admin/bill/checkvalidation',
            type: "POST",
            data: formData,
            dataType: 'json',
            contentType: false,
            ...
            success: function (data) {
                if (data.status == "fail") {
                   $.each(data.error, function(key, value) {
                    ...
                    initDatatable('allajaxlist', 'admin/bill/bill_reports/',data.param,[],100,[
