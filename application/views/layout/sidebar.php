...
<aside class="main-sidebar" id="alert2">
    ...
    <?php }?> 
    <section class="sidebar" id="sibe-box" style="background:linear-gradient( #898886, #635f5f, #898886);;">
        ...
        <ul class="sidebar-menu verttop">
            <li class="treeview <?php echo set_Topmenu('dashboard'); ?>">
                <a  href="<?php echo base_url(); ?>admin/admin/dashboard">
                   <i class="fas fa-television"></i> <span style=""> <?php echo $this->lang->line('dashboard'); ?></span>
               </a>
           </li>
            <?php
                if($this->module_lib->hasActive('patient')){
                    if ($this->rbac->hasPrivilege('patient', 'can_view')) {
                                ?> 
                    <li class="treeview <?php echo set_Topmenu('patients'); ?>">
                            ...
                            <li class="treeview <?php echo set_Topmenu('Certificate'); ?>">
                                ...
                                <ul class="treeview-menu" style="">
                                   <?php if ($this->rbac->hasPrivilege('certificate', 'can_view')) { ?>
                                    <li class="<?php echo set_Submenu('admin/generatecertificate'); ?>"><a style="" href="<?php echo base_url(); ?>admin/generatecertificate"><i class="fas fa-angle-right" style=""></i><?php echo $this->lang->line('certificate'); ?> </a></li>
                                <?php } if ($this->rbac->hasPrivilege('generate_patient_id_card', 'can_view')) { ?>
                                     <li class="<?php echo set_Submenu('admin/generatepatientidcard'); ?>"><a style="" href="<?php echo base_url('admin/generatepatientidcard/'); ?>"><i class="fas fa-angle-right" style=""></i><?php echo $this->lang->line('patient_id_card'); ?></a></li>
                                     <?php }  if ($this->rbac->hasPrivilege('generate_staff_id_card', 'can_view')) { ?>
                                    <li class="<?php echo set_Submenu('admin/generatestaffidcard'); ?>"><a style="" href="<?php echo base_url('admin/generatestaffidcard/'); ?>"><i class="fas fa-angle-right" style=""></i><?php echo $this->lang->line('staff_id_card');?></a></li>
                                <?php } ?>
                                </ul>
                            </li>
