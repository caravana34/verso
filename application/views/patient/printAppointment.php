                    ...
                    <div class="row">
                        ...
                        <table class="noborder_table">
                          ...
                          <tr>
                                ...
                                <td width="30%"><span id="appointmentno"><?php if(!empty($result['appointment_no'])){echo $result['appointment_no'];} ?></span>
                            ...
                            <tr>
                                <th width="50%"><?php echo $this->lang->line('patient_name'); ?></th>
                                <td width="50%"><span id='patient_name_view'><?php echo $result['patients_name']?></span></td>
...
<!--                             <tr>
                             ...
                             <tr>
                               ...
                               <th width="50%"><?php echo $this->lang->line('doctor'); ?></th>
                                <td width="50%"><?php echo composeStaffNameByString($result['name'],$result['surname'],$result['employee_id']);?></td>
                            </tr>
